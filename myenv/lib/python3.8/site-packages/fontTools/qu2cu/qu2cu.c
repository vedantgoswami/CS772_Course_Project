      ...
      for (;;) {
        if (likely(!__pyx_t_24)) {
          if (likely(PyList_CheckExact(__pyx_t_8))) {
            ...
            #else
            __pyx_t_6 = __Pyx_PySequence_ITEM(__pyx_t_8, __pyx_t_23); __pyx_t_23++; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 329, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_6);
            #endif
          } else {
            {
 ...
 */
      ...
      for (;;) {
        ...
        #else
        __pyx_t_3 = __Pyx_PySequence_ITEM(__pyx_t_8, __pyx_t_23); __pyx_t_23++; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 341, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        #endif
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyList_GET_SIZE(__pyx_t_17);
  #if !CYTHON_ASSUME_SAFE_MACROS
  ...
  for (;;) {
    ...
    #else
    __pyx_t_8 = __Pyx_PySequence_ITEM(__pyx_t_17, __pyx_t_1); __pyx_t_1--; if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 378, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    #endif
    if ((likely(PyTuple_CheckExact(__pyx_t_8))) || (PyList_CheckExact(__pyx_t_8))) {
      PyObject* sequence = __pyx_t_8;
